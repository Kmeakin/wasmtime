...
fn op_is_safe_for_fuzzing(op: &Op) -> bool {
    match op {
        ...
        Op::Fmov(_) => true,
        Op::Vmov(_) => true,
        Op::Xconst8(op::Xconst8 { .. }) => true,
        Op::Xconst16(op::Xconst16 { .. }) => true,
        Op::Xconst32(op::Xconst32 { .. }) => true,
        Op::Xconst64(op::Xconst64 { .. }) => true,
        Op::Xadd32(op::Xadd32 { .. }) => true,
        ...
        Op::BitcastIntFromFloat32(op::BitcastIntFromFloat32 { .. }) => true,
        ...
        Op::Call(_) => false,
        Op::Xeq64(Xeq64 { .. }) => true,
        Op::Xneq64(Xneq64 { .. }) => true,
        Op::Xslt64(Xslt64 { .. }) => true,
        Op::Xslteq64(Xslteq64 { .. }) => true,
        Op::Xult64(Xult64 { .. }) => true,
        Op::Xulteq64(Xulteq64 { .. }) => true,
        Op::Xeq32(Xeq32 { .. }) => true,
        Op::Xneq32(Xneq32 { .. }) => true,
        Op::Xslt32(Xslt32 { .. }) => true,
        Op::Xslteq32(Xslteq32 { .. }) => true,
        Op::Xult32(Xult32 { .. }) => true,
