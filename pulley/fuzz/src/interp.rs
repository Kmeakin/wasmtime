...
fn op_is_safe_for_fuzzing(op: &Op) -> bool {
    match op {
        ...
        Op::Xadd32(op::Xadd32 { operands, .. }) => !operands.dst.is_special(),
        Op::Xadd64(op::Xadd64 { operands, .. }) => !operands.dst.is_special(),
        Op::Load32U(_) => false,
        Op::Load32S(_) => false,
        Op::Load64(_) => false,
        ...
        Op::Call(_) => false,
        Op::Xeq64(Xeq64 { operands, .. }) => !operands.dst.is_special(),
        Op::Xneq64(Xneq64 { operands, .. }) => !operands.dst.is_special(),
        Op::Xslt64(Xslt64 { operands, .. }) => !operands.dst.is_special(),
        Op::Xslteq64(Xslteq64 { operands, .. }) => !operands.dst.is_special(),
        Op::Xult64(Xult64 { operands, .. }) => !operands.dst.is_special(),
        Op::Xulteq64(Xulteq64 { operands, .. }) => !operands.dst.is_special(),
        Op::Xeq32(Xeq32 { operands, .. }) => !operands.dst.is_special(),
        Op::Xneq32(Xneq32 { operands, .. }) => !operands.dst.is_special(),
        Op::Xslt32(Xslt32 { operands, .. }) => !operands.dst.is_special(),
        Op::Xslteq32(Xslteq32 { operands, .. }) => !operands.dst.is_special(),
        Op::Xult32(Xult32 { operands, .. }) => !operands.dst.is_special(),
